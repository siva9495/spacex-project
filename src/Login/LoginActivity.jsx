...
const LoginActivity = () => {
  ...
  return (
    <div className='login_container'>
        <div className='spacex_text'>
            <svg id='logo' version="1.1" x="0px" y="0px" viewBox="0 0 400 50" alt="SpaceX Logo">
        ...
        <div className='inner_frame_login' onClick={handleGoolgeLogin}>
